...
echo '<div class="ecco_lib">';
		...
		if ($resulttrue==false) echo $filtercontent->searchbar;
			...
			if ($resulttrue==true) $filtercontent->searchby.=' style="display:none"';
			$filtercontent->searchby.='>
...
<div style="margin-top: 30px;">
	<div class="row">
		...
		if ($ibd!=1) echo '<div class="col-sm-8 col-md-9 col-sm-pull-4 col-md-pull-3">';
		else echo '<div class="col-sm-12 col-md-12 col-sm-pull-12 col-md-pull-12">';
