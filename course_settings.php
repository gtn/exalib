...
if ($action == 'save_coursesettings') {
	...
	$out .= '<h3>'.block_exalib_trans('de:Änderungen wurden gespeichert!').'</h3>';
}
...
echo html_writer::tag('form',
	...
	html_writer::checkbox('allow_comments', 1, block_exalib_course_settings::allow_comments(), block_exalib_trans('de:Kommentarfunktion verwenden')).'<br />'.
	html_writer::checkbox('use_review', 1, block_exalib_course_settings::use_review(), block_exalib_trans('de:Reviewing verwenden')).'<br />'.
	html_writer::checkbox('use_terms_of_service', 1, block_exalib_course_settings::use_terms_of_service(), block_exalib_trans('de:Nutzungsbedingungen vor dem Erstellen von Inhalten/Fällen bestätigen')).'<br />'.
	html_writer::checkbox('alternative_wording', 1, block_exalib_course_settings::alternative_wording(), block_exalib_trans('de:Wording für Fallarchiv verwenden')).'<br />'.

	html_writer::select($categories, 'root_category_id', block_exalib_course_settings::root_category_id(), block_exalib_trans('de:-- keine --')).' '.block_exalib_trans('de:Einstiegsebene festlegen').'<br />'.
